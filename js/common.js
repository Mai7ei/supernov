$(document).ready(function(){
  ...
  $('.slider').slick({
   ...
   $('.slick_slider_who').slick({
    ...
    $(".slider_gallery_all").on('afterChange', function(event, slick, currentSlide){
...
$('.kitchen_blok_wrapper').hover(
    function() {
      $('.bg_lines_kitchen,.section_kitchen').addClass('active');
    }, function() {
      $('.bg_lines_kitchen,.section_kitchen').removeClass('active');
    }
  );
$('.cupboard_blok_wrapper').hover(
    function() {
      $('.bg_lines_cupboard,.section_cupboard').addClass('active');
    }, function() {
      $('.bg_lines_cupboard,.section_cupboard').removeClass('active');
    }
  );
